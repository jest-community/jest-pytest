...
class TestFeedreaderComponent(unittest.TestCase):
    ...
    def test_setup_one_feed(self):
        ...
        with patch("homeassistant.components.feedreader."
            ...
            self.assertTrue(
                setup_component(self.hass, feedreader.DOMAIN, VALID_CONFIG_1))
    ...
    def test_setup_scan_interval(self):
        ...
        with patch("homeassistant.components.feedreader."
                   "track_time_interval") as track_method:
            self.assertTrue(
                setup_component(self.hass, feedreader.DOMAIN, VALID_CONFIG_2))
    ...
    def test_setup_max_entries(self):
        ...
        self.assertTrue(
            setup_component(self.hass, feedreader.DOMAIN, VALID_CONFIG_3))
    ...
    def test_feed_updates(self):
        ...
        with patch(
                "homeassistant.components.feedreader.StoredData."
                "get_timestamp",
                return_value=time.struct_time((2018, 4, 30, 5, 10, 0, 0, 120,
                                               0))):
        ...
        with patch(
                "homeassistant.components.feedreader.StoredData."
                "get_timestamp",
                return_value=time.struct_time((2018, 4, 30, 5, 11, 0, 0, 120,
                                               0))):
